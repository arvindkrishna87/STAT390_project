...
**Aim**: To identify structurally similar slices across stains for each patient.
...
![](step%202%20images/slice1.png){width="125"} ![](step%202%20images/slice4.png){width="90"} ![](step%202%20images/slice5.png){width="106"} ![](step%202%20images/slice6.png){width="105"} ![](step%202%20images/slice2.png){width="121"} ![](step%202%20images/slice7.png){width="100"} ![](step%202%20images/slice3.png){width="113"}

**Successfully matched results**

![](step%202%20images/slice1.png){width="125"} ![](step%202%20images/slice2.png){width="121"} ![](step%202%20images/slice3.png){width="113"}
...
This tracker shows the status of each patient if they had a successful match

## API

![](step%202%20images/step%202%20API%20image%201.png)

![](step%202%20images/step%202%20API%20image%202.png)

## API Results

![](step%202%20images/step%202%20API%20image%203.png)
