...
As noted in the Slice Extraction and Matching steps, we have been working manually. We do, however, hope to make this whole process automated through a few key programs. These include slice extraction, tissue matching, and epithelium detection. 
...
<br>
We have two methods for this step.  Both work relaively well, but fail in specific cases.

## Cara's Method

Below is the documentation for Cara's Method in case you are interested in using this algorithm now. 
![Link](https://docs.google.com/document/d/1u3e0Bw7LGokr4gZgAOPgqrvykZYsyqcx-LGDGNzFQV0/edit?usp=sharing)
...
![](images/failedEpi1.png){fig-align="center" width = 60%}
![](images/failedEpi2.png){fig-align="center" width = 60%}
