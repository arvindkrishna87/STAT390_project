...
Most of these issues appear to stem from a lack of diverse samples. The algorithm as it currently stands does not take into account more complex sample attributes (limited testing on tissue holes, differently colored tissues, tissues with more than two relevant contours to take into account, etc.).
