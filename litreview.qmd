...
[**Link:**]{.underline} https://arxiv.org/pdf/2210.13364
...
[**Link:**]{.underline} https://blogs.mathworks.com/deep-learning/2021/11/02/handling-very-large-images

-in-medical-imaging-applications/

-   Image patches are usually square regions whose size can vary from 32 × 32 pixels up to 10,000 × 10,000 pixels (256 × 256 pixels is a typical patch size
