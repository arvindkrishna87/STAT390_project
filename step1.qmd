...
Using QuPath, we uploaded the data which was in WSIs. We created an automated tool using groovy, which extracts each individual tissue from the WSIs and places all the extracted tissue slices in a new data folder.
