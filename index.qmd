...
2. **Why is patch size in powers of 2? (e.g. 32 x 32, 256 x 256, 512 x 512, etc.) Are there alternatives?**  
   ...
   **Theoretical Analysis:**  
   We investigated the mathematical and computational advantages of powers of 2 in convolutional neural networks (CNNs).

   **Practical Examples:**  
   We examined earlier CNN architectures such as AlexNet alongside recent practices focused on hardware efficiency.
