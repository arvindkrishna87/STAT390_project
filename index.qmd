...
1.  Extracting tissue slices from Whole Slice Images (**WSI**) using QuPath
2.  Matching tissue slices across the different stains (**H&E, Melan-A, Sox-10**) for each patient when there is a correct match
3.  Detecting and extracting the epithelium and stroma for each tissue slice
4.  Apply patching across epithelium for matched slices
