...
Below are images comparing the outcome of our three approaches to the patching problem. Find more details on each algorithm below the comparison. 
...
| **Uses Pre-determined patch sizes**   |                    |         X           |        X        |
