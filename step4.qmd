...
| Pros              | Cons              |
|------------------|-----------------|
| - Patches grow until they cover a sufficient region of the epithelium, which allows for better adaptability across different epithelium widths <br>- Advantage 2 | - Incrementally increases patches using very small step sizes, making code time consuming (likely why this algorithm does not work as effectively with larger, thicker tissues (e.g. the large Copenhagen matches with only one slice per stain) <br>- Disadvantage 2 |
